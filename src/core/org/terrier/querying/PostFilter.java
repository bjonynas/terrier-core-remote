...
public interface PostFilter
{
	...
	/** Called before the processing of a resultset using this PostFilter is applied.
	  ...
	  */
	void new_query(ManagerInterface m, SearchRequest srq, ResultSet rs);
	/**
	  ...
	  */
	byte filter(ManagerInterface m, SearchRequest srq, ResultSet results, int DocAtNumber, int docid);
}
