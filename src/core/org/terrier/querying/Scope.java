...
public class Scope implements PostFilter
{
	...
	@Override
	public void new_query(ManagerInterface m, SearchRequest srq, ResultSet rs) {

	}

	@Override
	public byte filter(ManagerInterface m, SearchRequest srq, ResultSet results, int DocAtNumber, int docid) {
		return 0;
	}
}
