 ...
 */
public abstract class TRECQuerying {
	...
	public abstract void setIndex(Index i);

	public abstract ManagerInterface getManager();
	...
	public abstract SearchRequest processQuery(String queryId, String query,
											   double cParameter, boolean c_set);
